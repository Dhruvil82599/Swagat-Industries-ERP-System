...
export default function EmployeeDashboardPage() {
  ...
  const employeeModules = [
    ...
    },
    {
      ...
      desc: "Base salary definitions, monthly fixed pay scales, and compensation terms.",
      icon: <FiDollarSign />,
      accentColor: "#D96F0B",
      status: "Upcoming",
    },
    {
      id: "payments",
      phase: "Phase 5",
      title: "Salary Payments Ledger",
      desc: "Multi-transaction salary disbursements, partial payments, and advance settlements.",
      icon: <FiCreditCard />,
      accentColor: "#16A34A",
      status: "Upcoming",
    },
    {
      ...
      desc: "Independent overtime hours tracking, rate multipliers, and dedicated calculations.",
      icon: <FiClock />,
      accentColor: "#2563EB",
      status: "Upcoming",
    },
    {
      ...
      desc: "Identification proofs, KYC records, compliance attachments, and joining documents.",
      icon: <FiFileText />,
      accentColor: "#7C3AED",
      status: "Upcoming",
    },
    {
      ...
      desc: "Audit trails, monthly salary summaries, payment histories, and exportable statements.",
      icon: <FiLayers />,
      accentColor: "#0284C7",
      status: "Upcoming",
    },
